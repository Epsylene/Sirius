...
namespace Sirius
{
    ...
    ///
    /// @details This is a generic controller, that is not
    /// intended to be instanciated, but to be derived from. The
    /// controller provides functions to update a camera and set
    /// callbacks to events; as such, each Camera class shall
    /// have a CameraController class that will be the object
    /// actually used in the application's code.
    ...
    class CameraController2D: public CameraController
    {
        ...
        public:
            ...
            /// and right, X to reset the rotation) are set
            /// here.
    ...
    ///
    /// @details The controller allows control over the rotation
    ...
    class CameraController3D: public CameraController
    {
        private:
            ...
            /// @brief Mouse scroll event callback
            ///
            /// @details The zoom factor is inversely proportional to
            /// the scrolling offset.
            virtual bool onMouseScrolled(MouseScrolledEvent& event) override;
        ...
        public:
            ...
            ///
            /// @details This controller's camera is a default
            /// 3D camera with 16/9 aspect ratio.
            CameraController3D();
            ...
            /// @brief Updates the controller
            ///
            /// @detials The inputs (WASD to move, R and F to
            /// move up and down, mouse cursor to look around, Q
            /// and E to roll left and right, X to reset the
            /// rolling rotation) are set here.
            virtual void onUpdate(Timestep dt) override;
